...
public class MON_SkeletonLord extends Entity{
	...
	public void getImage() {
		...
		if(inRage == true) {
			...
			left2 = setup("/monster/skeletonlord_phase2_left_1", gp.tileSize*i, gp.tileSize*i);
...
//						+ "BOARDER--------------------------------------BOARDER\n"
		dialogues[0][0] = "Ah, another brave soul seeking glory\n"
						+ "in the face of death. You dare to challenge me?\n";
		dialogues[0][1] = "Prepare to face the wrath of the underworld!\n"
						+ "Foolish human, your feeble attempts to defeat me.\n";
		dialogues[0][2] = "You're just delaying the inevitable. \n"
						+ "I've ruled this domain for centuries,\n"
						+ "and your presence here means nothing.\n";	
		dialogues[0][3] = "You'll be just another soul lost in the abyss.\n"
						+ "You think you can defeat death itself?\n";
		dialogues[0][4] = "How amusing! I'll crush you and add your bones \n"
						+ "to my ever-growing army of the damned!\n";
	...
	public void setAction () {
		...
		// CHECK IF ATTACK
		if(attacking == false) {
			checkAttackOrNot(60, gp.tileSize*7, gp.tileSize*5); // MORE NUM MORE AGG
		}
