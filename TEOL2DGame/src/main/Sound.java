...
public class Sound {
	...
	public Sound() {
		...
		soundURL[0] = getClass().getResource("/sound/Title_Theme.wav");
		...
		soundURL[22] = getClass().getResource("/sound/Prepare_for_Battle!.wav");
	}
	...
	public void checkVolume() {
		...
		switch(volumeScale) {
			...
			case 1: volume = -50f; break;
			case 2: volume = -40f; break;
