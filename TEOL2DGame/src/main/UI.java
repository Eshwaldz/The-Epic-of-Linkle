...
public class UI {
	...
	public void drawMessage() {
		...
		for (int i = 0; i < message.size(); i++) {
			...
			if (message.get(i) != null) {
				...
				int counter = messageCounter.get(i) + 1; // SAME messageCounter++ but ArrayList
	...
	public void drawTitleScreen() {
		...
		if(titleScreenState == 0) {
			...
			String text = "The Epic of Linkle";
...
//			currentDialogue = npc.dialogues[npc.dialogueSet][npc.dialogueIndex];
	...
	public void drawInventory(Entity entity, boolean cursor) {
		...
		for (int i = 0; i < entity.inventory.size(); i++) {
			...
			if(entity == gp.player && entity.inventory.get(i).amount > 1) {
				...
				amountX = getXforAlignToRightText(s, slotX);
	...
	public void options_fullScreenNotification(int frameX, int frameY) {
		...
		currentDialogue = "Please restart the game \nto adjust the screen size.";
	...
	public void options_control(int frameX, int frameY) {
		...
		g2.drawString("Cast Spell", textX, textY); textY += gp.tileSize;
	...
	public void options_endGameConfirmation(int frameX, int frameY) {
		...
		currentDialogue = "Do you want to return \nto the title page?";
